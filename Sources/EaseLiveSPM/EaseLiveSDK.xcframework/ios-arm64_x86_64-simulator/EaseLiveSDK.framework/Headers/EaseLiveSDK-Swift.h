...
/// Sends a message to EaseLive with the current audio mute status
/// \param mute Audio volume between 0 - 100
///
- (void)onMuteChangedWithMute:(BOOL)mute;
/// Set the audio mute status
/// \param mute True is muted, false is unmuted
///
- (void)setMuteWithMute:(BOOL)mute;
/// Sends a message to EaseLive with the current video scale
/// \param scaleX Horizontal scale factor, between 0 and 1 
///
/// \param scaleY Vertical scale factor, between 0 and 1 
///
/// \param pivotX Horizontal anchor for the scaling animation, between 0 and 1 
///
/// \param pivotY Vertical anchor of the scaling animation, between 0 and 1 
///
/// \param duration Duration of the scale animation in milliseconds 
///
- (void)onVideoScaleWithScaleX:(float)scaleX scaleY:(float)scaleY pivotX:(float)pivotX pivotY:(float)pivotY duration:(NSInteger)duration;
/// Set the size of the video relative to its original size
/// \param scaleX Horizontal scale factor, between 0 and 1 
///
/// \param scaleY Vertical scale factor, between 0 and 1 
///
...
/// \param duration Duration of the scale animation in milliseconds 
///
- (void)setVideoScaleWithScaleX:(float)scaleX scaleY:(float)scaleY pivotX:(float)pivotX pivotY:(float)pivotY duration:(NSInteger)duration;
/// Detected swipe gesture on the overlay, outside any graphical elements
/// \param direction The direction of the swipe gesture 
///
- (void)didSwipeStageWithDirection:(UISwipeGestureRecognizerDirection)direction;
@end

@class UIView;
@class EaseLiveAvPlayer;
@class EaseLiveAvPlayerView;
@class CALayer;
...
@property (nonatomic, strong) EaseLiveAvPlayerView * _Nullable playerView;
@property (nonatomic) BOOL loop;
- (nonnull instancetype)initWithParentView:(UIView * _Nonnull)parentView url:(NSString * _Nonnull)url OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)createPlayer;
- (void)setVideoScaleWithScaleX:(float)scaleX scaleY:(float)scaleY pivotX:(float)pivotX pivotY:(float)pivotY duration:(NSInteger)duration;
- (void)playVideoUrlWithUrl:(NSString * _Nonnull)url;
...
- (void)setMuteWithMute:(BOOL)mute;
- (void)setStateWithState:(enum PlayerState)state;
- (void)onTimedMetadataAsyncWithItem:(AVMetadataItem * _Nonnull)item seekablePosition:(int64_t)seekablePosition seekableDuration:(int64_t)seekableDuration completionHandler:(void (^ _Nonnull)(BOOL))completionHandler SWIFT_AVAILABILITY(tvos,introduced=16) SWIFT_AVAILABILITY(ios,introduced=16);
...
- (void)setSelectedTracksWithTracks:(PlayerTracks * _Nonnull)tracks;
- (nonnull instancetype)initWithUrl:(NSString * _Nonnull)url SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC11EaseLiveSDK21CloudRenderViewPlugin") SWIFT_AVAILABILITY(tvos,introduced=13.0) SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface CloudRenderViewPlugin : NSObject <ViewPluginInterface>
- (void)setUrlWithUrl:(NSString * _Nonnull)url;
- (NSString * _Nullable)url SWIFT_WARN_UNUSED_RESULT;
- (void)create;
- (void)load;
...
- (nonnull instancetype)initWithUrl:(NSString * _Nonnull)url playerPlugin:(id <PlayerPluginInterface> _Nonnull)playerPlugin SWIFT_DEPRECATED_MSG("please migrate to init(parentView: UIView, webUrl: String, playerPlugin: PlayerPluginInterface)");
...
- (nonnull instancetype)initWithUrl:(NSString * _Nonnull)url videoUrl:(NSString * _Nonnull)videoUrl SWIFT_UNAVAILABLE_MSG("migrate to init(parentView: UIView, webUrl: String, playerPlugin: PlayerPluginInterface)");
/// Initialize EaseLive
...
- (void)setUrlWithUrl:(NSString * _Nonnull)url SWIFT_UNAVAILABLE_MSG("'setUrl' has been renamed to 'setUrlWithWebUrl:'");
- (void)setUrlWithWebUrl:(NSString * _Nonnull)webUrl;
- (void)setUrlWithVideoUrl:(NSString * _Nonnull)videoUrl;
...
- (BOOL)hasFocus SWIFT_WARN_UNUSED_RESULT;
...
- (void)onMuteChangedWithMute:(BOOL)mute;
- (void)onTimeControlStatusChangedWithStatus:(enum AVPlayerTimeControlStatus)status;
...
+ (EaseLiveError * _Nonnull)bridgeInitWithLevel:(enum EaseLiveErrorLevel)level reason:(NSString * _Nonnull)reason originalError:(NSError * _Nullable)originalError SWIFT_WARN_UNUSED_RESULT;
+ (EaseLiveError * _Nonnull)bridgeConnectivityWithLevel:(enum EaseLiveErrorLevel)level reason:(NSString * _Nonnull)reason originalError:(NSError * _Nullable)originalError SWIFT_WARN_UNUSED_RESULT;
+ (EaseLiveError * _Nonnull)viewInitWithLevel:(enum EaseLiveErrorLevel)level reason:(NSString * _Nonnull)reason originalError:(NSError * _Nullable)originalError SWIFT_WARN_UNUSED_RESULT;
+ (EaseLiveError * _Nonnull)viewConnectivityWithLevel:(enum EaseLiveErrorLevel)level reason:(NSString * _Nonnull)reason originalError:(NSError * _Nullable)originalError SWIFT_WARN_UNUSED_RESULT;
+ (EaseLiveError * _Nonnull)playerInitWithLevel:(enum EaseLiveErrorLevel)level reason:(NSString * _Nonnull)reason originalError:(NSError * _Nullable)originalError SWIFT_WARN_UNUSED_RESULT;
+ (EaseLiveError * _Nonnull)playerConnectivityWithLevel:(enum EaseLiveErrorLevel)level reason:(NSString * _Nonnull)reason originalError:(NSError * _Nullable)originalError SWIFT_WARN_UNUSED_RESULT;
...
/// Swipe gesture on the background of the overlay.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull bridgeStageSwipe;)
+ (NSNotificationName _Nonnull)bridgeStageSwipe SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull bridgeStageTouchStart;)
+ (NSNotificationName _Nonnull)bridgeStageTouchStart SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull bridgeStageTouchMove;)
+ (NSNotificationName _Nonnull)bridgeStageTouchMove SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull bridgeStageTouchEnd;)
+ (NSNotificationName _Nonnull)bridgeStageTouchEnd SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull bridgeStageTouchCancel;)
+ (NSNotificationName _Nonnull)bridgeStageTouchCancel SWIFT_WARN_UNUSED_RESULT;
...
/// The web app wants the player to mute its audio.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull bridgeMute;)
+ (NSNotificationName _Nonnull)bridgeMute SWIFT_WARN_UNUSED_RESULT;
/// The web app wants the player to scale the video
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull bridgeVideoScale;)
+ (NSNotificationName _Nonnull)bridgeVideoScale SWIFT_WARN_UNUSED_RESULT;
...
/// The player changed the audio mute.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull playerMute;)
+ (NSNotificationName _Nonnull)playerMute SWIFT_WARN_UNUSED_RESULT;
/// The player changed the video scale
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull playerVideoScale;)
+ (NSNotificationName _Nonnull)playerVideoScale SWIFT_WARN_UNUSED_RESULT;
...
/// userInfo field in notification <code>playerMute</code> and <code>bridgeMute</code>, containing a <code>Bool</code> object
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull muteUserInfoKey;)
+ (NSString * _Nonnull)muteUserInfoKey SWIFT_WARN_UNUSED_RESULT;
/// userInfo field in notification <code>bridgeStageSwipe</code>, containing a <code>String</code> object
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull directionUserInfoKey;)
+ (NSString * _Nonnull)directionUserInfoKey SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull videoScaleXUserInfoKey;)
+ (NSString * _Nonnull)videoScaleXUserInfoKey SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull videoScaleYUserInfoKey;)
+ (NSString * _Nonnull)videoScaleYUserInfoKey SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull videoPivotXUserInfoKey;)
+ (NSString * _Nonnull)videoPivotXUserInfoKey SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull videoPivotYUserInfoKey;)
+ (NSString * _Nonnull)videoPivotYUserInfoKey SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull videoScaleDurationUserInfoKey;)
+ (NSString * _Nonnull)videoScaleDurationUserInfoKey SWIFT_WARN_UNUSED_RESULT;
/// userInfo field in notification <code>bridgeStageTouchStart</code>, containing a <code>String</code> object
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull idUserInfoKey;)
+ (NSString * _Nonnull)idUserInfoKey SWIFT_WARN_UNUSED_RESULT;
/// userInfo field in notification <code>bridgeStageTouchStart</code>, containing a <code>Int</code> object
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull xUserInfoKey;)
+ (NSString * _Nonnull)xUserInfoKey SWIFT_WARN_UNUSED_RESULT;
/// userInfo field in notification <code>bridgeStageTouchStart</code>, containing a <code>Int</code> object
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull yUserInfoKey;)
+ (NSString * _Nonnull)yUserInfoKey SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC11EaseLiveSDK24SecondScreenPlayerPlugin")
@interface SecondScreenPlayerPlugin : PlayerPluginBase
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)destroy;
- (void)setStateWithState:(enum PlayerState)state;
- (void)setTimeWithTime:(int64_t)time;
